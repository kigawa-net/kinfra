package net.kigawa.kinfra.infra.bitwarden
...
class BitwardenSecretManagerRepositoryImpl(
    ...
    private fun ensureBwsInstalled(): String {
        ...
        val platform =
            when {
                os.contains("linux") && (arch.contains("amd64") || arch.contains(
                    "x86_64"
        ...
        try {
            ...
            throw IllegalStateException(
                "Failed to install bws CLI: ${e.message}\n" +
                    "Please install manually: https://github.com/bitwarden/sdk-sm/releases",
                e,
            )
        }
    }
